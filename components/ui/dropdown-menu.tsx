...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(commonItem, "px-2 py-1.5", inset && "pl-8", "data-[state=open]:bg-accent", className)}
    {...props}
  >
    {children}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(panelBase.replace("min-w-[10rem]", "min-w-[8rem]"), className)}
    {...props}
  />
))
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(commonItem, "px-2 py-1.5", inset && "pl-8", className)}
    {...props}
  />
))
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(commonItem, "py-1.5 pl-8 pr-2", className)}
    checked={checked}
    {...props}
  >
