...
export const updates: UpdateItem[] = [
  {
    date: "2026/04/24",
    title: "文章タイプと詳しさを選べるようになりました",
    note: "「商品ページ用」・「こんな人におすすめ」・「よくある質問」・「新商品・入荷案内」から文章の形を選び、詳しさも調整できるようになりました。",
  },
  {
    date: "2026/04/11",
    title: "Writer機能の文章品質を改善しました",
    note: "入力内容の反映を見直し、これまでより自然で使いやすい文章が生成されやすくなりました。",
  },
  {
    date: "2026/03/01",
